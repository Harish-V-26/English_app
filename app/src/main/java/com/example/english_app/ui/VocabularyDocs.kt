...
val docWords3 = listOf(
    ...
    Word("Incensed", "", "Advanced form of 'angry' ΓÇö very angry.", "The teacher was incensed by the team's grave mistake.", "incensed"),
    Word("Amble", "", "Advanced form of 'walk' ΓÇö to walk slowly and relaxed.", "I like to amble along the riverside."),
    Word("Deplorable", "", "Advanced form of 'bad' ΓÇö very poor or shocking.", "My friend's hostel was in a deplorable state.", "deplorable"),
    Word("Pristine", "", "Advanced form of 'new' ΓÇö spotless, in original condition.", "Her desk is always pristine.", "pristine"),
    Word("Venerable", "", "Advanced form of 'old' ΓÇö respected because of age.", "I visited a venerable church in Venice.", "venerable"),
    Word("Perpetually", "", "Advanced form of 'always' ΓÇö constantly, without stopping.", "My friend is perpetually worried about her examination.", "perpetually"),
    Word("Reticent", "", "Advanced form of 'quiet' ΓÇö reserved, not saying much.", "Vijay is reticent about the recent issue.", "reticent"),
    Word("Notion", "", "Advanced form of 'idea' ΓÇö a belief or plan.", "My friend has a notion to travel abroad.", "notion"),
    Word("Perplexing", "", "Advanced form of 'confusing' ΓÇö very puzzling.", "Her idea was perplexing.", "perplexing"),
    Word("Petrified", "", "Advanced form of 'scared' ΓÇö frozen with fear.", "He was petrified at the sight of a lion in front of him.", "petrified"),
    Word("Dine", "", "Advanced form of 'eat' ΓÇö to eat a meal, usually formally.", "They decided to dine at a multi-cuisine restaurant.", "dine"),
    Word("Recurrently", "", "Advanced form of 'often' ΓÇö happening again and again.", "He lost his job as he made mistakes recurrently.", "recurrently"),
    Word("Sporadically", "", "Advanced form of 'sometimes' ΓÇö occurring at irregular intervals.", "I go to that hotel sporadically.", "sporadically"),
    Word("Amiable", "", "Advanced form of 'nice' ΓÇö friendly and pleasant.", "She has a most amiable personality.", "amiable"),
    Word("Meager", "", "Advanced form of 'little' ΓÇö very small in amount.", "People got meager food after the disaster.", "meager"),
    Word("Apprehensive", "", "Advanced form of 'nervous' ΓÇö anxious about something.", "She felt apprehensive about presenting the seminar.", "apprensive"),
    Word("Tenuous", "", "Advanced form of 'weak' ΓÇö flimsy, barely valid.", "They presented tenuous evidence.", "tenuous"),
    Word("Tardy", "", "Advanced form of 'late' ΓÇö slow to arrive or act.", "The student was marked tardy for arriving after the bell.", "tardy"),
    Word("Bestow", "", "Advanced form of 'give' ΓÇö to formally present something.", "The father bestowed his blessings on his newborn child.", "bestow"),
    Word("Craft", "", "Advanced form of 'make' ΓÇö to skillfully create.", "She crafts beautiful jewellery from gold.", "craft"),
    Word("Lucid", "", "Advanced form of 'clear' ΓÇö easy to understand.", "Her essay is lucid in style.", "lucid"),
    Word("Imminently", "", "Advanced form of 'soon' ΓÇö about to happen very shortly.", "The examinations will commence imminently.", "imminently"),
    Word("Discourteous", "", "Advanced form of 'rude' ΓÇö impolite.", "The guest was discourteous to all.", "discourteous"),
    Word("Engrossed", "", "Advanced form of 'busy' ΓÇö fully absorbed in something.", "She was engrossed in her video call.", "engrossed"),
    Word("Surmise", "", "Advanced form of 'guess' ΓÇö to conclude from limited evidence.", "I surmise he forgot to take his tablet.", "surmise"),
    Word("Cogitate", "", "Advanced form of 'think' ΓÇö to think deeply.", "She cogitated on the issue deeply.", "cogitate"),
    Word("Obstinate", "", "Advanced form of 'stubborn' ΓÇö unwilling to change one's mind.", "She is obstinate in negotiations."),
    Word("Negligent", "", "Advanced form of 'careless' ΓÇö failing to take proper care.", "The security guard was negligent in his duty.", "negligence"),
    Word("Turmoil", "", "Advanced form of 'trouble' ΓÇö a state of great disturbance.", "The city was in turmoil after the political rally.", "turmoil"),
